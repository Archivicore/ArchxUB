...
_checkDefaultVars() {
    ...
    declare -rA def_vals=(
        ...
        [UPSTREAM_REPO]="https://github.com/Archivicore/ArchxUB"
...
_setupPlugins() {
    ...
    if test $(grep -P '^'$2'$' <<< $3); then
        ...
        rm -rf Archx/plugins/$path/
        mv $tmp/plugins/ Archx/plugins/$path/
...
_checkUnoffPlugins() {
    _setupPlugins UnOfficial true $LOAD_UNOFFICIAL_PLUGINS https://github.com/Archivicore/Archx-Plugins.git
}
