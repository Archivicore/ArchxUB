...
import Archx  # pylint: disable=unused-import
...
class RawClient(Client):
    ...
    def __init__(self, bot: Optional['Archx.core.client.ArchxBot'] = None, **kwargs) -> None:
        self._bot = bot
        super().__init__(**kwargs)
        self._channel = Archx.core.types.new.ChannelLogger(self, "CORE")
        Archx.core.types.new.Conversation.init(self)
