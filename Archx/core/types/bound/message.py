...
class Message(RawMessage):
    """ Modded Message Class For Archx """
    def __init__(self,
    ...
    @classmethod
    def parse(cls, client: Union['_client.Archx', '_client.ArchxBot'],
    ...
    @property
    def client(self) -> Union['_client.Archx', '_client.ArchxBot']:
        """ returns client """
        return self._client
    ...
    async def err(self,
        ...
        Returns:
            On success,
            If Client of message is Archx:
                the sent :obj:`Message` or True is returned.
            if Client of message is ArchxBot:
