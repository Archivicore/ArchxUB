...
from Archx.utils import SafeDict, get_file_id_of_media, parse_buttons
...
class ChannelLogger:
    """ Channel logger for Archx """
    def __init__(self, client: Union['_client.Archx', '_client.ArchxBot'], name: str) -> None:
    ...
    async def forward_stored(self,
                             client: Union['_client.Archx', '_client.ArchxBot'],
                             message_id: int,
                             chat_id: int,
                             user_id: int,
        ...
        Parameters:
            client (`Archx` | `ArchxBot`):
                Pass Archx or ArchxBot.
