...
@Archx.on_cmd('dthumb', about={'header': "Delete thumbnail"}, allow_channels=False)
async def clear_thumb_nail(message: Message):
    ...
    elif os.path.exists('resources/Archx.png'):
        os.remove('resources/Archx.png')
        await message.edit("✅ Default thumbnail deleted succesfully.", del_in=3)
    else:
        await message.delete()


@Archx.on_cmd('vthumb', about={'header': "View thumbnail"}, allow_channels=False)
