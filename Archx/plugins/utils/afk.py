...
from Archx import Archx, Message, filters, Config, get_collection
...
@Archx.on_filters(IS_AFK_FILTER & ~filters.me & ~filters.bot & ~filters.edited & (
...
@Archx.on_filters(IS_AFK_FILTER & filters.outgoing, group=-1, allow_via_bot=False)
