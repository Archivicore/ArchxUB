...
@Archx.on_cmd("Oof$", about={'header': "Ooooof"},
               trigger='', allow_via_bot=False)
...
@Archx.on_cmd("Hmm$", about={'header': "Hmmmmm"},
               trigger='', allow_via_bot=False)
...
@Archx.on_cmd("clock$", about={'header': "kensar clock animation"})
...
@Archx.on_cmd("(yes|no|maybe|decide)$", about={
