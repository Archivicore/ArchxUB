...
from Archx.utils import humanbytes, time_formatter, sort_file_name_key
...
@Archx.on_cmd('drename ([^|]+)\|([^|]+)', about={  # noqa
...
@Archx.on_cmd(r'split (\d+) ([\s\S]+)', about={
    'header': "Split files",
