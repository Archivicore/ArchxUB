...
from Archx import Archx, pool, Message, Config
from Archx.plugins.misc.upload import get_thumb, remove_thumb
        ...
        try:
            ...
            # This is a nightmare.
                ...
                for _ in range(4):
                    ...
                    async with Archx.conversation(message.from_user.id) as asker:
