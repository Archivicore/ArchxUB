...
from Archx import Archx, Message, Config, get_collection, pool
from Archx.utils import humanbytes, time_formatter
from Archx.utils.exceptions import ProcessCanceled
from Archx.plugins.misc.download import url_download, tg_download
...
class _GDrive:
    ...
    def _upload_file(self, file_path: str, parent_id: str) -> str:
        ...
        body = {"name": file_name, "mimeType": mime_type, "description": "Uploaded using Archx"}
        if parent_id:
...
@Archx.on_cmd("gsetup", about={
    'header': "Setup GDrive Creds"})
async def gsetup_(message: Message):
    """ setup creds """
    link = "https://theArchx.github.io/deployment.html#3-g_drive_client_id--g_drive_client_secret"
