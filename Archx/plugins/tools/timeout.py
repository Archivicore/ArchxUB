...
@Archx.on_cmd("vdelto", about={'header': "View auto message delete timeout"})
...
@Archx.on_cmd("vwelto", about={'header': "View auto welcome/left message delete timeout"})
...
@Archx.on_cmd("vapicto", about={'header': "View auto profile picture timeout"})
...
@Archx.on_cmd("vesto", about={'header': "View edit sleep timeout"})
